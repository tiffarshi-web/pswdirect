CREATE OR REPLACE FUNCTION public.complete_shift_signout(_booking_id uuid, _care_sheet jsonb, _sign_out_lat numeric, _sign_out_lng numeric, _sign_out_accuracy_m numeric, _sign_out_distance_m numeric, _sign_out_outside_radius boolean, _care_sheet_flagged boolean, _care_sheet_flag_reason jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  -- Convert jsonb flag reason (array of strings) into text[] to match the column type.
