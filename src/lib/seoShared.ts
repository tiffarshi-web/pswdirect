...
export const getCityFAQs = (city: string) => [
  ...
  },
  {
    ...
    answer: `Home care through PSW Direct in ${city} starts at $40 per hour for personal care and companionship visits. Doctor escort services start at $50 per hour. There are no contracts, agency fees, or hidden charges.`,
  },
  {
...
export const getServiceFAQs = (serviceLabel: string, city: string) => [
  ...
  },
  {
    ...
    answer: `${serviceLabel} through PSW Direct in ${city} starts at $40 per hour. There are no agency fees, contracts, or hidden charges. Book online in minutes.`,
  },
  {
