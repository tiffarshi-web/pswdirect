...
const PSWvsNurseDifference = () => (
  ...
  >
      ...
      <div className="overflow-x-auto mt-3">
        <table className="w-full text-left border border-border rounded-lg overflow-hidden">
          ...
          <tbody className="text-sm">
            ...
            <tr><td className="px-4 py-3 border-b border-border">Cost (typical)</td><td className="px-4 py-3 border-b border-border">$35–$50/hr</td><td className="px-4 py-3 border-b border-border">$50–$80/hr</td></tr>
    ...
    <section>
      ...
      <p>
        The majority of home care needs in Ontario are non-clinical. Families looking for daily living support, companionship, and personal care are best served by a qualified PSW. PSW Direct makes it easy to book vetted personal support workers starting at $40 per hour — no contracts, no agency delays.
      </p>
    </section>
  </GuideLayout>
);
