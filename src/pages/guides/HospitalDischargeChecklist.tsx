...
const HospitalDischargeChecklist = () => (
  ...
  >
    ...
    <section>
      ...
      <p>
        A personal support worker can provide critical assistance during the recovery period — from helping with bathing and dressing to preparing meals and accompanying your loved one to follow-up appointments. PSW Direct offers hospital discharge support starting at $50 per hour, with vetted caregivers available across Toronto and Ontario.
      </p>
    </section>
  </GuideLayout>
);
