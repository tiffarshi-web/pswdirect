...
const CostOfHomeCareOntario = () => (
  <GuideLayout
    ...
    metaDescription="How much does home care cost in Ontario? Compare agency rates vs. PSW Direct pricing. Home care starts at $40/hour with no contracts."
  ...
  >
    ...
    <section>
      ...
      <ul className="list-disc list-inside space-y-2 mt-3">
        ...
        <li><strong>Private PSW hire (independent):</strong> $20–$40 per hour (unvetted, no backup coverage)</li>
        <li><strong>PSW Direct platform:</strong> Starting at $40 per hour with vetted caregivers</li>
        <li><strong>Doctor escort services:</strong> Starting at $50 per hour</li>
        <li><strong>Hospital discharge support:</strong> Starting at $50 per hour</li>
      </ul>
    </section>
    ...
    <section>
      ...
      <p>
        PSW Direct eliminates traditional agency overhead. Families pay transparent hourly rates starting at $40 per hour — significantly less than the $55+ charged by most Toronto home care agencies. All PSWs are credential-verified, and booking takes minutes online.
      </p>
    </section>
  </GuideLayout>
);
