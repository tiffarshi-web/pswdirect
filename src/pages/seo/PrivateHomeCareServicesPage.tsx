...
const faqItems = [
  ...
  { q: "How much do home care services cost?", a: "Private home care services through PSW Direct start at $40 per hour — significantly less than the $55+ charged by traditional home care agencies. There are no contracts, no sign-up fees, and no hidden charges." },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            deliver compassionate care across Ontario — starting at $40/hr with no contracts or agency fees.
          </p>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 pt-4">
              ...
              <div className="bg-card rounded-xl p-5 border border-border text-center">
                ...
                <h3 className="font-semibold text-foreground mb-1">$40/hr Starting Rate</h3>
