...
const faqItems = [
  ...
  { q: "How much do private home care services cost?", a: "Private home care services through PSW Direct start at $30 per hour — significantly less than the $55+ charged by traditional home care agencies. There are no contracts, no sign-up fees, and no hidden charges." },
...
const PrivateHomeCareServicesPage = () => {
  ...
  const homeCareServiceJsonLd = {
    ...
    description: "Affordable private home care services across Ontario. Vetted personal support workers and in-home caregivers for seniors and families.",
    url: canonicalUrl,
    telephone: "+1-249-288-4787",
    priceRange: "$30-$35",
    serviceType: ["Private Home Care", "In-Home Caregiver", "Personal Support Worker", "Private Nursing Care at Home", "Home Care Services", "Companionship Care", "Post-Surgery Recovery"],
