...
const config: HighConvertPageConfig = {
  ...
  description: "Hospital discharge care across Ontario. A vetted PSW handles pickup, transport home, settling in, and immediate post-discharge support. From $50/hr — no contracts.",
  ...
  faqs: [
    ...
    { question: "How much does hospital discharge care cost in Ontario?", answer: "Hospital discharge care starts at $50/hr — covering transport, waiting time, prescription pickup, home setup, and immediate post-discharge care. No contracts, no hidden fees." },
