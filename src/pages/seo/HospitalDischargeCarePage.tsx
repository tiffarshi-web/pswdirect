...
const config: HighConvertPageConfig = {
  ...
  description: "Hospital discharge care across Ontario. A vetted PSW handles pickup, transport home, settling in, and immediate post-discharge support. From $45/hr — no contracts.",
  ...
  faqs: [
    ...
    { question: "How much does hospital discharge care cost in Ontario?", answer: "Hospital discharge care starts at $45/hr — covering transport, waiting time, prescription pickup, home setup, and immediate post-discharge care. No contracts, no hidden fees." },
