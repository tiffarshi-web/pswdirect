...
const description = "Find affordable in-home care across Ontario. PSW Direct connects families with vetted personal support workers for senior care, personal care, and companionship from $40/hr.";
...
const faqs = [
  ...
  { question: "How much does in-home care cost in Ontario?", answer: "In-home care through PSW Direct starts at $40/hr — significantly less than the $55+/hr charged by traditional home care agencies." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
          ...
          for personal care, companionship, senior care, and more — starting at $40/hr with no contracts.
        </p>
      ...
      <section className="px-4 py-12">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-8 text-center">Browse by Service Type</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {services.map(({ label, key }) => (
              <Link key={key} to={`/${key}-toronto`} className="bg-card rounded-lg p-3 text-center border border-border hover:border-primary hover:shadow-md transition-all text-sm font-medium text-foreground">
                {label}
              </Link>
            ))}
          </div>
...
export default InHomeCareOntarioPage;
