...
const config: HighConvertPageConfig = {
  ...
  description: "Find private home care near you in Ontario. PSW Direct matches you with vetted personal support workers for personal care, companionship, and more from $35/hr.",
  ...
  faqs: [
    ...
    { question: "Is private home care better than agency care?", answer: "Private home care through PSW Direct costs $35/hr vs $55+/hr at traditional agencies. You get the same vetted, qualified PSWs without the agency markup, contracts, or wait times." },
