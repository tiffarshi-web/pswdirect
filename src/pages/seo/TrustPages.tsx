...
const pages: Record<string, HighConvertPageConfig> = {
  "trusted-home-care-services": {
    ...
    description: "Trusted home care services across Ontario. Every PSW Direct caregiver is credential-verified, police-checked, and reviewed. Book trusted care from $40/hr.",
  ...
  "vetted-psw-caregivers": {
    ...
    description: "All PSW Direct caregivers are fully vetted — PSW certificate verified, government ID checked, and police background screened. Book a vetted caregiver from $40/hr.",
  ...
  "licensed-insured-caregivers": {
    ...
    description: "Licensed and credentialed caregivers across Ontario. PSW Direct verifies every caregiver's PSW certificate, ID, and background check. Book from $40/hr, no contracts.",
  ...
  "background-checked-caregivers": {
    ...
    description: "Every PSW Direct caregiver is police background-checked with a Vulnerable Sector Check. Book a background-checked caregiver in Ontario from $40/hr.",
