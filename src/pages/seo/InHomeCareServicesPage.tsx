...
const config: HighConvertPageConfig = {
  ...
  description: "Professional in-home care services across Ontario. Book vetted personal support workers for personal care, elderly care, companionship, and post-hospital support from $40/hr.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "In-home care through PSW Direct starts at $40/hr for personal care and companionship. Doctor escort starts at $50/hr. No contracts, no agency fees.",
    },
    {
