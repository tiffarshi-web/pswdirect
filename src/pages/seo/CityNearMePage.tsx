...
const variantConfig: Record<string, (city: string, slug: string) => HighConvertPageConfig> = {
  "home-care": (city, slug) => ({
    ...
    description: `Looking for home care near you in ${city}, Ontario? PSW Direct provides same-day, vetted personal support workers for in-home care from $40/hr. No contracts.`,
    headline: `Home Care Near You in ${city}`,
    subheadline: `Need home care near you in ${city}? PSW Direct provides vetted personal support workers for same-day in-home care — personal care, companionship, and mobility support from $40/hr.`,
    breadcrumbTrail: [
    ...
    faqs: [
      ...
      { question: `How much does home care cost near ${city}?`, answer: `Home care through PSW Direct in ${city} starts at $40/hr. No agency fees, no contracts, no hidden charges.` },
    ],
  }),
  "caregiver": (city, slug) => ({
    slug,
    ...
    description: `Find a trusted caregiver near you in ${city}, Ontario. Vetted home caregivers for personal care, companionship, and senior support from $40/hr. Book same-day.`,
  ...
  "psw": (city, slug) => ({
    ...
    description: `Find a PSW near you in ${city}, Ontario. Vetted personal support workers for home care, senior care, and daily living assistance from $40/hr. Book same-day.`,
    ...
    faqs: [
      ...
      { question: `How much does a PSW cost in ${city}?`, answer: `PSWs through PSW Direct in ${city} start at $40/hr for personal care and $50/hr for doctor escorts. No contracts or agency fees.` },
    ],
  }),
};
