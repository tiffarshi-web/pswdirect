...
const variantConfig: Record<string, (city: string, slug: string) => HighConvertPageConfig> = {
  ...
  "psw": (city, slug) => ({
    ...
    faqs: [
      ...
      { question: `How much does a PSW cost in ${city}?`, answer: `PSWs through PSW Direct in ${city} start at $35/hr for personal care and $45/hr for doctor escorts. No contracts or agency fees.` },
    ],
  }),
};
