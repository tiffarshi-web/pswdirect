...
const configs: Record<string, HighConvertPageConfig> = {
  "home-care": {
    ...
    faqs: [
      ...
      { question: "How much does home care cost?", answer: "Home care starts at $35/hr for personal care and companionship. Doctor escort starts at $35/hr. No agency fees, no contracts, no hidden charges." },
    ],
  },
