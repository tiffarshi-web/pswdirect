...
const configs: Record<string, HighConvertPageConfig> = {
  "home-care": {
    ...
    description: "Professional home care services across Ontario. Vetted personal support workers for bathing, companionship, mobility support, and more. From $40/hr, no contracts.",
    ...
    faqs: [
      ...
      { question: "How much does home care cost?", answer: "Home care starts at $40/hr for personal care and companionship. Doctor escort starts at $50/hr. No agency fees, no contracts, no hidden charges." },
    ],
  },
  "personal-support-worker": {
    slug: "personal-support-worker",
    title: "Personal Support Worker Services | Hire a PSW Online | PSW Direct",
    description: "Hire a personal support worker in Ontario. Fully vetted PSWs for elderly care, post-surgery support, and daily living assistance. Book online from $40/hr.",
    headline: "Hire a Personal Support Worker in Ontario",
    subheadline: "PSW Direct connects you with credential-verified, police-checked personal support workers across Ontario. On-demand booking, no contracts, care from $40/hr.",
  ...
  "caregiver-services": {
    ...
    description: "Professional caregiver services in Ontario. Trusted in-home caregivers for seniors, post-surgery recovery, and daily living support. Book online from $40/hr.",
  ...
  "in-home-care": {
    ...
    description: "In-home care services across Ontario. Personal support workers come to your home for bathing, companionship, mobility support, and senior care. From $40/hr.",
