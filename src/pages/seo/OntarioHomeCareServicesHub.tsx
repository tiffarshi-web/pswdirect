...
const description = "Complete directory of PSW Direct home care services across Ontario. Browse by city, service type, or condition. Book vetted PSWs online from $40/hr.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-12 md:py-16 max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
          ...
          Every page connects you with vetted personal support workers — book online from $40/hr with no contracts.
        </p>
      </section>
