...
const configs: Record<string, HighConvertPageConfig> = {
  "help-with-bathing-elderly": {
    ...
    description: "Professional bathing assistance for elderly loved ones in Ontario. Vetted PSWs provide dignified personal hygiene support at home. Book same-day from $40/hr.",
  ...
  "senior-transportation-services": {
    ...
    description: "Senior transportation and medical escort services in Ontario. Vetted PSWs drive and accompany seniors to doctor appointments, hospitals, and errands. From $50/hr.",
  ...
  "doctor-appointment-assistance": {
    ...
    description: "Doctor appointment assistance and medical escort services in Ontario. A vetted PSW accompanies your loved one to appointments and provides door-to-door support. From $50/hr.",
  ...
  "companionship-for-seniors": {
    ...
    description: "Companionship services for seniors in Ontario. Vetted PSWs provide conversation, activities, walks, and social engagement to combat isolation. From $40/hr.",
  ...
  "meal-preparation-for-seniors": {
    ...
    description: "Meal preparation services for seniors in Ontario. Vetted PSWs prepare nutritious meals, assist with feeding, and ensure proper nutrition. From $40/hr.",
