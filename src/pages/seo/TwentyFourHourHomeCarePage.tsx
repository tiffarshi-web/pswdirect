...
const config: HighConvertPageConfig = {
  ...
  description: "24-hour home care across Ontario. Rotating shifts of vetted personal support workers provide continuous in-home care for seniors and post-hospital patients. From $30/hr.",
  ...
  faqs: [
    ...
    { question: "How much does 24-hour home care cost in Ontario?", answer: "24-hour home care through PSW Direct starts at $30/hr for personal care. Daily totals are significantly lower than long-term care or live-in agencies — and there are no contracts." },
