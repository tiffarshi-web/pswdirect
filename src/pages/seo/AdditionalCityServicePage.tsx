...
const serviceContent: Record<string, {
  ...
  "on-demand-home-care": {
    ...
    faqs: [
      ...
      { question: "How much does on-demand care cost?", answer: "On-demand home care through PSW Direct starts at $40/hr — significantly less than traditional agencies. No hidden fees or surge pricing." },
    ],
  },
  "hospital-discharge": {
  ...
  "in-home-care-services": {
    ...
    sections: [
      ...
      "Our in-home care is flexible — book by the hour, choose your schedule, and adjust as needs change. No contracts, no minimum commitments, and transparent pricing from $40/hr.",
    ],
    faqs: [
  ...
  "psw-services-in": {
    ...
    sections: [
      ...
      "All PSW Direct caregivers are credential-verified with police background checks, government ID verification, and valid PSW certificates. Book online with transparent pricing starting at $40/hr.",
    ],
    faqs: [
  ...
  "home-care-in": {
    heroDesc: "Professional home care services from vetted personal support workers. Book online with no contracts and transparent pricing starting at $40/hr.",
    sections: [
    ...
    faqs: [
      ...
      { question: "How much does home care cost?", answer: "Home care through PSW Direct starts at $40/hr — significantly less than traditional agencies. No contracts, no hidden fees." },
    ],
  },
  "private-home-care-in": {
    ...
    faqs: [
      { question: "What is private home care?", answer: "Private home care means hiring a caregiver directly rather than through a traditional agency. PSW Direct facilitates this connection with vetted PSWs at $40/hr — vs $55+/hr at agencies." },
...
const AdditionalCityServicePage = ({ city, service, serviceLabel, slug }: Props) => {
  ...
  const description = `${serviceLabel} in ${city}, Ontario. Vetted personal support workers available same-day. Book online from $40/hr — no contracts.`;
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-muted/50 px-4 py-10 border-y border-border">
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <p className="text-primary text-2xl font-bold">$40/hr</p>
        ...
        <section className="px-4 py-12 max-w-4xl mx-auto">
          ...
          <ul className="space-y-3">
            {[
              ...
              "Transparent pricing from $40/hr — no agency markup",
