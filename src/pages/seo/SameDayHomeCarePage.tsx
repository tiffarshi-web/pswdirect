...
const config: HighConvertPageConfig = {
  ...
  description: "Need home care today? PSW Direct provides same-day PSW services across Ontario. Vetted caregivers, no contracts, from $30/hr. Book online in minutes.",
  ...
  faqs: [
    ...
    { question: "Is same-day care more expensive?", answer: "No. Same-day home care starts at the same $30/hr rate. There are no rush fees, surge pricing, or hidden charges." },
