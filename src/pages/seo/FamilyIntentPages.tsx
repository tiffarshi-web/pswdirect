...
const configs: Record<string, HighConvertPageConfig> = {
  "help-for-elderly-parents-at-home": {
    ...
    description: "Get help for your elderly parents at home in Ontario. Vetted personal support workers provide bathing, meals, companionship, and daily living assistance from $40/hr.",
    ...
    faqs: [
      ...
      { question: "How much does elderly home care cost?", answer: "Care starts at $40/hr with PSW Direct — significantly less than agency rates of $55+/hr. No contracts, no hidden fees. Pay only for the hours you need." },
    ],
  },
  "care-for-aging-parents": {
    slug: "care-for-aging-parents",
    title: "Care for Aging Parents | Senior Home Care Ontario | PSW Direct",
    description: "Professional care for aging parents in Ontario. Vetted PSWs provide personal care, companionship, and daily living support in your parent's home. From $40/hr.",
  ...
  "help-with-elderly-parent-daily-care": {
    ...
    description: "Get daily care help for your elderly parent in Ontario. Personal support workers assist with bathing, meals, medication, and companionship. Book same-day from $40/hr.",
  ...
  "support-for-seniors-at-home": {
    ...
    description: "In-home support for seniors across Ontario. Vetted personal support workers provide companionship, personal care, and daily living assistance. From $40/hr, no contracts.",
  ...
  "care-for-elderly-after-hospital": {
    ...
    description: "Post-hospital care for elderly parents in Ontario. Vetted PSWs provide discharge support, recovery assistance, and daily care at home. Book same-day from $40/hr.",
