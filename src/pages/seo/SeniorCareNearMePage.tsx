...
const description = "Find trusted senior care near you in Ontario. PSW Direct connects families with vetted caregivers for elderly home care, companionship, and personal support — starting at $40/hr.";
...
const faqs = [
  ...
  { question: "How much does senior home care cost?", answer: "Senior home care through PSW Direct starts at $40/hr. Traditional agencies charge $55+. No hidden fees or long-term commitments." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
          ...
          for elderly home care, companionship, mobility support, and more — starting at $40/hr with no contracts.
        </p>
