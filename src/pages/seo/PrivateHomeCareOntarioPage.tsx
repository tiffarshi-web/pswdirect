...
const description = "Find affordable home care across Ontario. PSW Direct connects families with vetted personal support workers and caregivers in 25+ cities. No contracts, starting at $40/hr.";

const faqItems = [
  { q: "What is home care?", a: "Private home care is personalized in-home support provided by a personal support worker (PSW) or caregiver, hired directly rather than through a traditional agency. PSW Direct connects families with vetted caregivers across Ontario starting at $40/hr." },
  { q: "How much does home care cost in Ontario?", a: "Private home care through PSW Direct starts at $40 per hour — nearly half the cost of traditional agencies which charge $55+. There are no contracts, sign-up fees, or hidden charges." },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            or full-time private nursing care at home, we make it simple — starting at $40/hr with no contracts.
          </p>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="text-center mt-6">
              <p className="text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                ...
                Families across Ontario can hire a personal support worker online starting at $40 per hour —
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6">
                <p className="text-primary text-3xl font-bold mb-2">$40/hr</p>
        ...
        <section className="px-4 py-12 text-center">
          ...
          <a href="https://pswdirect.ca/">
            <Button size="lg" className="text-lg px-8 py-6">Book Now — Starting at $40/hr</Button>
          </a>
        </section>
