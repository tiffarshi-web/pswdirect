...
const metaMap = {
  "psw-near-me": {
    ...
    description: "Looking for a PSW near you? Book trusted personal support workers across Toronto, the GTA, and Ontario starting at $40 per hour.",
  },
  "home-care-near-me": {
    title: "Home Care Near Me | Affordable In-Home Support | PSW Direct",
    description: "Find affordable home care near you. Book vetted personal support workers across Toronto, the GTA, and Ontario starting at $40 per hour.",
  },
  "personal-support-worker-near-me": {
    title: "Personal Support Worker Near Me | PSW Direct",
    description: "Looking for a personal support worker near you? Book trusted home care services across Toronto, the GTA, and Ontario starting at $40 per hour.",
  },
};
      ...
      <div className="min-h-screen bg-background pb-16 md:pb-0">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            and post-hospital recovery — online in minutes with transparent pricing starting at $40 per hour.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground text-sm">
                Home care starting at $40 per hour — traditional agencies charge $55+
              </p>
            </div>
            <div className="text-center p-6">
        ...
        <section className="px-4 py-12 max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <div className="bg-card rounded-xl p-6 shadow-card border border-border flex-1 min-w-[220px]">
              ...
              <p className="text-primary text-3xl font-bold mt-2">$40</p>
            ...
            <div className="bg-card rounded-xl p-6 shadow-card border border-border flex-1 min-w-[220px]">
              ...
              <p className="text-primary text-3xl font-bold mt-2">$50</p>
              <p className="text-muted-foreground text-sm mt-1">per hour</p>
            </div>
          </div>
          <a href="https://pswdirect.ca/">
