...
const HomeCareKeywordCityPage = ({ city, slug, keyword, keywordLabel }: Props) => {
  ...
  const description = `Find affordable ${keywordLabel.toLowerCase()} in ${city}, Ontario. PSW Direct connects families with vetted personal support workers — book online from $40/hr with no contracts.`;
  ...
  const faqs = [
    { question: `How much does ${keywordLabel.toLowerCase()} cost in ${city}?`, answer: `${keywordLabel} through PSW Direct in ${city} starts at $40/hr. Traditional agencies charge $55+. No contracts or hidden fees.` },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            Find affordable {keywordLabel.toLowerCase()} in {city}. PSW Direct connects families with vetted personal support workers — book online from $40/hr with no contracts.
          </p>
