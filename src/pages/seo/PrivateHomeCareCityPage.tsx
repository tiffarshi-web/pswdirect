...
const buildCityFAQs = (city: string) => [
  ...
  { q: `How much does home care cost in ${city}?`, a: `Private home care in ${city} through PSW Direct starts at $40 per hour — compared to $55+ at traditional agencies. There are no contracts, no sign-up fees, and no hidden charges.` },
...
const PrivateHomeCareCityPage = ({ city, slug }: Props) => {
  ...
  const description = `Find affordable home care in ${city}. PSW Direct connects families with vetted personal support workers and in-home caregivers. Starting at $40/hr, no contracts.`;
  ...
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: `PSW Direct — Home Care ${city}`,
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify(buildBreadcrumbList([
          ...
          { name: "Home Care Ontario", url: `${SITE_URL}/private-home-care-ontario` },
          { name: `Home Care ${city}`, url: canonicalUrl },
        ]))}</script>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            in {city}. Hire a PSW starting at $40/hr — no contracts, no agency fees.
          </p>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                starting at $40 per hour — compared to $55+ at conventional agencies. There are
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our home care services in {city} include companionship, personal hygiene
          ...
          <section className="bg-muted/50 px-4 py-12 border-y border-border">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-6">
                Our 75km service radius means home care from PSW Direct covers {city} and
        ...
        <InlineLinkParagraph city={city} service="Private Home Care" />
