...
const description =
  "How much does a Personal Support Worker cost in Ontario? Compare PSW rates, understand pricing factors, and see how PSW Direct offers care from $40/hour.";
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "PSW rates in Ontario typically range from $25 to $55 per hour depending on the provider. Traditional home care agencies charge $40–$55/hr. PSW Direct offers personal support worker services starting at $40/hr by connecting families directly with verified PSWs.",
              },
            },
            {
              "@type": "Question",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 sm:py-24 bg-primary/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            Understand home care pricing, compare agency vs. direct rates, and learn how PSW Direct keeps costs lower — starting at <strong className="text-foreground">$40/hour</strong>.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border">
                <tr className="bg-primary/5">
                  ...
                  <td className="px-6 py-4 text-primary font-bold">From $40/hr</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-muted-foreground">$20 – $40/hr</td>
      ...
      <section className="py-12 bg-primary text-primary-foreground text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="mb-6 opacity-90">Verified PSWs from $40/hour — no agency fees, no hidden costs.</p>
