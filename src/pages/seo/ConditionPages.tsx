...
const pages: Record<string, HighConvertPageConfig> = {
  "dementia-care-at-home": {
    ...
    description: "Professional dementia care at home in Ontario. Vetted PSWs provide supervision, personal care, routine support, and companionship for dementia patients from $40/hr.",
    ...
    faqs: [
      ...
      { question: "How much does dementia care at home cost?", answer: "Dementia home care through PSW Direct starts at $40/hr — significantly less than the $4,000-$8,000/month cost of memory care facilities." },
    ],
  },
  "alzheimers-care-at-home": {
    slug: "alzheimers-care-at-home",
    title: "Alzheimer's Care at Home | Home Alzheimer's Support | PSW Direct",
    description: "In-home Alzheimer's care across Ontario. Vetted personal support workers provide daily supervision, personal care, and safety monitoring for Alzheimer's patients from $40/hr.",
  ...
  "stroke-recovery-care-at-home": {
    ...
    description: "Post-stroke recovery care at home in Ontario. Vetted PSWs assist with mobility, personal care, speech exercises, and daily living tasks during stroke recovery from $40/hr.",
  ...
  "post-surgery-care-at-home": {
    ...
    description: "Post-surgery home care in Ontario. Vetted PSWs help with mobility, wound care support, meals, and daily living during surgical recovery. From $40/hr, no contracts.",
  ...
  "mobility-assistance-for-seniors": {
    ...
    description: "Mobility assistance for seniors in Ontario. Vetted PSWs help with walking, transfers, fall prevention, and daily movement safely at home. From $40/hr.",
  ...
  "fall-risk-care-for-elderly": {
    ...
    description: "Fall prevention care for elderly loved ones in Ontario. Vetted PSWs provide supervised mobility, home safety monitoring, and daily support to prevent falls from $40/hr.",
  ...
  "palliative-care-at-home": {
    ...
    description: "Compassionate palliative care at home in Ontario. Vetted PSWs provide comfort care, personal support, and companionship for end-of-life patients and families from $40/hr.",
  ...
  "overnight-care-for-seniors": {
    ...
    description: "Overnight care for seniors in Ontario. Vetted PSWs provide night-time supervision, bathroom assistance, and safety monitoring for elderly loved ones from $40/hr.",
    ...
    faqs: [
      ...
      { question: "How much does overnight care cost?", answer: "Overnight care through PSW Direct is billed at the standard hourly rate of $40/hr. An 8-hour overnight shift costs approximately $320." },
