...
const pages: Record<string, HighConvertPageConfig> = {
  ...
  "blue-cross-home-care-coverage": {
    ...
    description: "Blue Cross home care coverage in Ontario. PSW Direct provides itemized invoices accepted by Blue Cross for PSW and home care reimbursement. Book care from $40/hr.",
