...
const config: HighConvertPageConfig = {
  ...
  title: "Doctor Escort Service in Ontario | PSW Medical Escort from $50/hr | PSW Direct",
  description: "Doctor escort service across Ontario. A vetted PSW transports your loved one to medical appointments, waits, and brings them home safely. From $50/hr — book online.",
  ...
  faqs: [
    ...
    { question: "How much does a doctor escort service cost in Ontario?", answer: "Doctor escort service through PSW Direct starts at $50/hr — including transport time, waiting time, and the safe return trip. There are no contracts or hidden fees." },
