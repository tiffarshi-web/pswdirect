...
const longTailPages: Record<string, HighConvertPageConfig> = {
  "help-for-my-elderly-mother-at-home": {
    ...
    description: "Need help caring for your elderly mother at home? PSW Direct provides vetted personal support workers for bathing, meals, companionship, and daily care from $30/hr.",
    ...
    faqs: [
      ...
      { question: "How much does it cost to care for my mother at home?", answer: "Care starts at $30/hr with PSW Direct — 40-50% less than traditional agency rates. No contracts, no hidden fees." },
  ...
  "help-for-my-elderly-father-at-home": {
    ...
    description: "Need help caring for your elderly father at home? PSW Direct provides vetted personal support workers for personal care, mobility help, and companionship from $30/hr.",
  ...
  "someone-to-care-for-elderly-parent": {
    ...
    description: "Looking for someone to care for your elderly parent? PSW Direct provides vetted in-home caregivers for personal care, meals, and companionship across Ontario from $30/hr.",
  ...
  "home-care-after-surgery-at-home": {
    ...
    description: "Need home care after surgery? PSW Direct provides vetted personal support workers for post-surgery recovery at home — mobility help, meals, and daily care from $30/hr.",
  ...
  "caregiver-for-dementia-at-home": {
    ...
    description: "Find a dementia caregiver for home care in Ontario. PSW Direct provides experienced, vetted personal support workers for dementia and Alzheimer's care from $30/hr.",
  ...
  "help-with-daily-care-for-seniors": {
    ...
    description: "Need daily care help for a senior loved one? PSW Direct provides vetted personal support workers for daily bathing, meals, companionship, and mobility from $30/hr.",
    ...
    faqs: [
      ...
      { question: "How much does daily senior care cost?", answer: "Daily care starts at $30/hr with PSW Direct. A typical 3-hour daily visit costs $90/day — significantly less than agency rates." },
    ],
  },
  "someone-to-check-on-elderly-parent": {
    ...
    description: "Need someone to check on your elderly parent? PSW Direct provides vetted caregivers for wellness checks, companionship, and safety monitoring in Ontario from $30/hr.",
  ...
  "affordable-home-care-services": {
    ...
    title: "Affordable Home Care Services Ontario | From $30/hr | PSW Direct",
    description: "Affordable home care services in Ontario from $30/hr. PSW Direct eliminates agency markup — vetted caregivers, no contracts, no hidden fees. Book same-day.",
    headline: "Affordable Home Care Services in Ontario",
    subheadline: "Quality home care shouldn't break the bank. PSW Direct connects you directly with vetted personal support workers from $30/hr — eliminating the agency middleman and saving families 40-50% on care costs.",
    ...
    faqs: [
      ...
      { question: "Are there any hidden fees?", answer: "None. PSW Direct charges a flat hourly rate — $30/hr for personal care, $35/hr for doctor escorts. No signup fees, no cancellation penalties, no contracts." },
  ...
  "help-for-elderly-near-me": {
    ...
    description: "Find help for elderly loved ones near you in Ontario. PSW Direct provides vetted caregivers for personal care, companionship, and daily support from $30/hr. Book same-day.",
  ...
  "urgent-home-care-near-me": {
    ...
    description: "Need urgent home care near you? PSW Direct provides same-day vetted personal support workers for emergency and urgent care needs across Ontario from $30/hr.",
    ...
    faqs: [
      ...
      { question: "Is urgent home care more expensive?", answer: "No. Standard rates apply — from $30/hr for personal care. No surge pricing, no emergency fees." },
