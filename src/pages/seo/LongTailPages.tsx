...
const longTailPages: Record<string, HighConvertPageConfig> = {
  ...
  "affordable-home-care-services": {
    ...
    faqs: [
      ...
      { question: "Are there any hidden fees?", answer: "None. PSW Direct charges a flat hourly rate — $35/hr for personal care, $45/hr for doctor escorts. No signup fees, no cancellation penalties, no contracts." },
