      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify(buildFAQSchema([
            ...
            { question: "How much does a PSW cost?", answer: "Home care through PSW Direct starts at $35/hr for personal care and companionship. Doctor escort starts at $45/hr. No agency fees or hidden charges." },
          ]))}
        </script>
      </Helmet>
