  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:description" content="Find trusted PSWs across Ontario. Book in-home care starting at $40/hr." />
        ...
        <script type="application/ld+json">
          {JSON.stringify(buildFAQSchema([
            ...
            { question: "How much does a PSW cost?", answer: "Home care through PSW Direct starts at $40/hr for personal care and companionship. Doctor escort starts at $50/hr. No agency fees or hidden charges." },
          ]))}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-14 md:py-20 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            caregiver near you — book online in minutes with transparent pricing starting at $40 per hour.
          </p>
