...
const config: HighConvertPageConfig = {
  ...
  description: "Find elderly care near you in Ontario. PSW Direct provides vetted personal support workers for senior home care, companionship, and daily living assistance from $35/hr.",
  ...
  faqs: [
    ...
    { question: "How much does elderly home care cost in Ontario?", answer: "PSW Direct offers elderly care starting at $35/hr. Traditional agencies charge $55+/hr for the same services. No contracts, no hidden fees." },
