...
const config: HighConvertPageConfig = {
  ...
  title: "Elderly Care at Home in Ontario | Private PSW from $35/hr | PSW Direct",
  description: "Compassionate elderly care at home across Ontario. Vetted personal support workers help seniors with bathing, meals, mobility, and companionship. From $35/hr — no contracts.",
  ...
  faqs: [
    ...
    { question: "How much does elderly care at home cost in Ontario?", answer: "Elderly care at home through PSW Direct starts at $35/hr — significantly less than agency rates of $50–$60/hr. No contracts, no minimum hours after the first booking." },
