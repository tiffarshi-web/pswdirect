...
const defaultFaqs = (city?: string): { question: string; answer: string }[] => {
  ...
  return [
    ...
    },
    {
      ...
      answer: `Home care through PSW Direct starts at $45/hr for personal care and companionship. Doctor escort starts at $45/hr. No agency fees, no hidden charges.`,
    },
    {
