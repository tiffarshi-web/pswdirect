...
const config: HighConvertPageConfig = {
  ...
  description: "Find a trusted caregiver near you in Ontario. PSW Direct connects families with vetted home caregivers for personal care, companionship, and senior support from $30/hr.",
  ...
  faqs: [
    ...
    { question: "How much does a caregiver cost in Ontario?", answer: "Through PSW Direct, home caregivers start at $30/hr — significantly less than traditional agencies that charge $55+/hr. No contracts or hidden fees." },
