...
const META_DESC =
  "Book private home care in Toronto with no contracts. Verified PSWs for senior care, companionship, post-surgery recovery & more — starting at $40/hr.";

const faqs = [
  { question: "How much does home care cost in Toronto?", answer: "Home care through PSW Direct in Toronto starts at $40/hr — about half the cost of traditional agencies ($55+). No contracts, no hidden fees." },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-14 md:py-20 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-10">
            ...
            Quality senior care and elderly care starts at just $40/hr.
          </p>
        ...
        <section className="px-4 py-16">
          <div className="max-w-3xl mx-auto text-center bg-primary/5 rounded-2xl p-10 border border-primary/20">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              ...
              No contracts, no agency fees — just quality private home care starting at $40/hr.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/">
                <Button size="lg" className="text-lg px-8 py-6 gap-2">
