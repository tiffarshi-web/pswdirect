...
const config: HighConvertPageConfig = {
  ...
  description: "Find senior home care near you in Ontario. PSW Direct matches you with vetted personal support workers for elderly care, companionship, and daily living support from $40/hr.",
  ...
  faqs: [
    ...
    { question: "How much does senior home care cost near me?", answer: "Senior home care through PSW Direct starts at $50/hr. Doctor escorts start at $50/hr. No contracts, no agency markups, no hidden fees." },
