...
const config: HighConvertPageConfig = {
  ...
  description: "Book vetted home care in Barrie. PSW Direct connects families with personal support workers for senior care, companionship, and doctor escorts from $30/hr. Same-day available.",
  ...
  faqs: [
    ...
    { question: "How much does home care cost in Barrie?", answer: "Home care through PSW Direct in Barrie starts at $30/hr for personal care and companionship. Doctor escort starts at $35/hr. No agency fees." },
