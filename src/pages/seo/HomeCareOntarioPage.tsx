...
const description = "Find affordable home care across Ontario. PSW Direct connects families with vetted personal support workers in 25+ cities. Book online starting at $40/hr.";

const faqItems = [
  { q: "How much does a PSW cost in Ontario?", a: "PSW Direct starts at $40 per hour. Traditional agencies charge $55+. No contracts or commitments required." },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            Browse by city or service type to find a caregiver near you — starting at $40 per hour with no contracts.
          </p>
