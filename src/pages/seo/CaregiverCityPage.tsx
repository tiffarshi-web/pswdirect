...
const CaregiverCityPage = ({ city, slug }: Props) => {
  ...
  const faqs = [
    ...
    { question: `How much does a caregiver cost in ${city}?`, answer: `Through PSW Direct, caregivers in ${city} start at $35/hr for personal care and $35/hr for medical escorts. No agency fees, no contracts, no hidden charges.` },
