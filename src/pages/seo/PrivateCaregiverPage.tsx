...
const description = "Hire a private caregiver in Ontario without agency fees. PSW Direct connects families with vetted personal support workers for affordable in-home care from $40/hr.";
...
const faqs = [
  ...
  { question: "How much does a private caregiver cost?", answer: "Private caregivers through PSW Direct start at $40/hr — significantly less than the $55+/hr charged by traditional agencies." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-12 md:py-16 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-8">
          ...
          in-home care — starting at $40/hr with no contracts or hidden fees.
        </p>
