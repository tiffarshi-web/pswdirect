...
const config: HighConvertPageConfig = {
  ...
  description: "Post-hospital care at home across Ontario. Vetted PSWs help with discharge, mobility, meals, medication reminders, and recovery. From $30/hr — no contracts.",
  headline: "Post-Hospital Care at Home",
  subheadline: "A vetted personal support worker helps your loved one recover safely at home after a hospital stay. Same-day discharge support across Ontario from $30/hr.",
  breadcrumbTrail: [
  ...
  faqs: [
    ...
    { question: "How much does post-hospital care cost in Ontario?", answer: "Post-hospital care starts at $30/hr through PSW Direct. Doctor escort and medical transport for follow-up appointments start at $35/hr." },
