...
const config: HighConvertPageConfig = {
  ...
  faqs: [
    ...
    { question: "How much does post-hospital care cost in Ontario?", answer: "Post-hospital care starts at $45/hr through PSW Direct. Doctor escort and medical transport for follow-up appointments start at $45/hr." },
