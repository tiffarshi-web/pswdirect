...
const config: HighConvertPageConfig = {
  ...
  description: "Book vetted home care in Toronto. PSW Direct connects families with personal support workers for senior care, companionship, doctor escorts & more from $45/hr. Same-day available.",
