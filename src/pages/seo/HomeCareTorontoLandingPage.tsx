...
const config: HighConvertPageConfig = {
  ...
  description: "Book vetted home care in Toronto. PSW Direct connects families with personal support workers for senior care, companionship, doctor escorts & more from $35/hr. Same-day available.",
  ...
  faqs: [
    ...
    { question: "How much does home care cost in Toronto?", answer: "Home care through PSW Direct in Toronto starts at $35/hr for personal care and companionship. Doctor escort starts at $35/hr. No agency fees or hidden charges." },
