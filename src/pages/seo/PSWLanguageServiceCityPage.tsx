...
const serviceDescription = (service: string, lang: string, city: string) => {
  const descriptions: Record<string, string> = {
    "caregiver": `Find trusted ${lang} speaking caregivers in ${city}. Book vetted, police-checked personal support workers who speak ${lang} for in-home care starting at $40/hour.`,
...
const PSWLanguageServiceCityPage = ({
  ...
  const pageDescription = hc
    ? `${languageLabel} speaking home care services in ${city}, Ontario. Book vetted caregivers who speak ${languageLabel} for personal care, companionship, and daily living support — from $40/hour.`
    : `Find ${languageLabel} speaking ${serviceLabel.toLowerCase()} providers in ${city}. Vetted caregivers who speak ${languageLabel} — book online starting at $40/hour.`;
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg bg-card border border-border">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">From $40/hour</p>
            </div>
          </div>
        </section>
          ...
          {hc ? (
            <>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                {languageLabel} speaking caregivers in {city} starting at $40/hour.
              </p>
            </>
          ) : (
            <>
        ...
        <section className="text-center py-10 bg-primary/5 rounded-lg border border-primary/10">
          ...
          <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
            {hc
              ? `Quality home care from ${languageLabel} speaking caregivers in ${city} — starting at $40/hour. All caregivers are vetted and police-checked.`
              : `Quality ${serviceLabel.toLowerCase()} from ${languageLabel} speaking caregivers — starting at $40/hour. All caregivers are vetted and police-checked.`
            }
          </p>
          <Link to="/book">
