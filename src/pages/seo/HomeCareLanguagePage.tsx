...
const HomeCareLanguagePage = ({ language, slug }: Props) => {
  const config: HighConvertPageConfig = {
    ...
    description: `Find ${language}-speaking home care and personal support workers in Ontario. Book a ${language}-speaking PSW online from $40/hr — no contracts.`,
    ...
    faqs: [
      ...
      { question: `How much does ${language}-speaking home care cost?`, answer: `The same transparent rate as all PSW Direct services — starting at $40/hr. There is no premium for language-specific matching.` },
